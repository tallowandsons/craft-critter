...
describe('GeneratorHelper CLI Exclusion', function () {
    it('does not register CLIGenerator by default', function () {
        ...
        expect(class_exists(\mijewe\critter\generators\CriticalCssCliGenerator::class))->toBeTrue();
    });

    it('allows DotComGenerator to be available', function () {
        expect(class_exists(\mijewe\critter\generators\CriticalCssDotComGenerator::class))->toBeTrue();
    });

    it('allows DummyGenerator to be available', function () {
        expect(class_exists(\mijewe\critter\generators\DummyGenerator::class))->toBeTrue();
    });

    it('allows NoGenerator to be available', function () {
        expect(class_exists(\mijewe\critter\generators\NoGenerator::class))->toBeTrue();
    });
});
